...
INDEX_LINK_TEMPLATES = {
    ...
    "producteur": [None, None, None, None, "forum"],
...
CATEGORY_MAPPING = {
    ...
    "label": "labels",
    "lexique": "lexique",
    "animateur_radio": "animateurs radio",
    "chaine_tv": "chaines tv",
    "club": "clubs",
    "collection": "collections",
    "documentaire": "documentaires",
    "emission_radio": "emissions radio",
    "emission_tv": "emissions tv",
    "emission_web": "emissions web",
    "film": "films",
    "genre_musical": "genres musicaux",
    "jeu_video": "jeux video",
    "livre": "livres",
    "magazine": "magazines",
    "producteur": "producteurs",
    "pub_tv": "publicites tv",
    "reportage": "reportages",
    "serie": "series",
    "site_web": "sites web",
    "station_radio": "stations radio",
    "webradio": "webradios",
}
